...
/* Definitions for task_lld_contro */
osThreadId_t task_lld_controHandle;
const osThreadAttr_t task_lld_contro_attributes = {
  .name = "task_lld_contro",
  .stack_size = 384 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
int main(void)
{
  ...
  /* creation of task_lld_contro */
  task_lld_controHandle = osThreadNew(start_task_lld_controller, NULL, &task_lld_contro_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, STBY_Pin|LED_CAN_Pin|LED_WORK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : STBY_Pin LED_CAN_Pin LED_WORK_Pin */
  GPIO_InitStruct.Pin = STBY_Pin|LED_CAN_Pin|LED_WORK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : OPT_Pin */
  GPIO_InitStruct.Pin = OPT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(OPT_GPIO_Port, &GPIO_InitStruct);
...
/* USER CODE BEGIN Header_start_task_lld_controller */
/**
* @brief Function implementing the task_lld_contro thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_start_task_lld_controller */
void start_task_lld_controller(void *argument)
{
  ...
  /* USER CODE END start_task_lld_controller */
}
